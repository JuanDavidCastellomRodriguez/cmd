...
$info_predios = mysql_query($query_info_predios, $CMS) or die(mysql_error());
$row_info_predios = mysql_fetch_assoc($info_predios);
$totalRows_info_predios = mysql_num_rows($info_predios);
  ...
  <body>
    ...
    <script>
      ...
      var locations = [
		...
		<?php	  
		  } while ($row_info_predios = mysql_fetch_assoc($info_predios));
		?>
      ]
    </script>
