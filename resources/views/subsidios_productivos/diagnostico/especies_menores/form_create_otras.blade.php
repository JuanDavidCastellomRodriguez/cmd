                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-lg-6 col-sm-12 col-md-6">
                            ...
                            <input required="required" type="text"  class="form-control" v-model="nuevaOtras.especie">
                        </div>

                        <div class="form-group col-lg-6 col-sm-12 col-md-6">
                            <label for="exampleInputName2">Cantidad</label>
                            <input type="number" required="required" class="form-control" id="exampleInputName2" v-model="nuevaOtras.cantidad_animales">
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="exampleInputName2">Observaciones</label>
                            <textarea rows="5" required="required" class="form-control" id="exampleInputName2" v-model="nuevaOtras.observaciones"></textarea>
                        </div>
                    </div>
