                    ...
                    <div class="row">
                            ...
                            <div class=" form-group col-lg-6 col-sm-12">
                                <label for="exampleInputName2">Fecha Encuesta</label>
                                    ...
                                    <input type="text" name="fecha_encuesta" id="fecha_encuesta" class="form-control" required v-model="nuevoDiagnostico.fecha_encuesta">
                            ...
                            <div class="form-group col-lg-6 col-sm-12">
                                ...
                                <input type="number" required class="form-control" id="exampleInputName2" v-model.number="nuevoDiagnostico.no_familias_vivienda">
                            </div>
