...
return [
    ...
    */
    ...
    'required'             => strtoupper(':attribute').': El campo '.ucfirst(':attribute').' es obligatorio.',
    ...
    */
    ...
    'custom' => [
        'nombre_completo' => [
            'required_if' => 'El campo Nombre completo es requerido a menos que Tipo de identidad sea diferente de NIT',
        ],
        'primer_nombre' => [
            'required_unless' => 'El campo Primer nombre es requerido a menos que Tipo de identidad se encuentre en NIT',
        ],
        'primer_apellido' => [
            'required_unless' => 'El campo Primer apellido es requerido a menos que Tipo de identidad se encuentre en NIT',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        'ct_tpclcuenta_id'=> 'Tipo',
        'ct_ntclcuenta_id'=> 'Naturaleza',
        'bs_tpdcidentidad_id'=> 'Tipo identidad',
        'identificacion'=> 'Identificación',
        'municipio_expedicion'=> 'Municipio de expedición',
        'tipo_retencion'=> 'Tipo retención',
        'tipo_contribuyente'=> 'Tipo contribuyente',
        'municipio_ubicacion'=> 'Municipio de ubucación',
        'direccion'=> 'Dirección',
        'autorretenedor_de'=>'Autorretenedor de'
    ],
